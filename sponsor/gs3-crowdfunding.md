...
![Crowdfunding committed amount (EUR)](/img/posts/2.26/gs3-amount.png){: .guage loading="lazy" width="365" height="371"}

![Crowdfunding progress percentage](/img/posts/2.26/gs3-percent.png){: .guage loading="lazy" width="365" height="371"}
